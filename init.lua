...
vim.keymap.set('n', '<A-S-Right>', '<C-w>L', { desc = 'Move window to the right' })
vim.keymap.set('n', '<A-S-Down>', '<C-w>J', { desc = 'Move window to the lower' })
vim.keymap.set('n', '<A-S-Up>', '<C-w>K', { desc = 'Move window to the upper' })
